...
function HeroButtons() {
  ...
  return (
    ...
    <div className="mx-auto mb-12 flex w-full max-w-sm flex-col items-stretch justify-center gap-3 sm:mb-16 sm:max-w-none sm:flex-row sm:items-center sm:gap-5">
      ...
      >
        <span className="relative inline-block h-[1.4em] overflow-hidden whitespace-nowrap text-[clamp(0.875rem,2.6vw,1rem)] leading-[1.4em]">
          <motion.span variants={textUpVariant} className="inline-block">
            {primary.label}
          </motion.span>
          <motion.span
