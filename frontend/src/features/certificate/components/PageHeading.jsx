...
function PageHeadingBase() {
  return (
    <motion.header
      ...
      animate="visible"
    >
      <span className="mb-3 mt-3 rounded-full border border-white/15 bg-white/[0.06] px-4 py-1 text-[11px] font-semibold uppercase tracking-[0.2em] text-[#F4A261] backdrop-blur-md">
        {PAGE_CONTENT.eyebrow}
      </span>
      <h1 className="text-3xl font-heading font-extrabold tracking-wide text-white sm:text-4xl">
        {PAGE_CONTENT.title}
      </h1>
