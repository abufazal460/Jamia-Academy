...
function FloatingLabelBase({ htmlFor, text, isFloating, direction = "fade" }) {
  ...
  return (
    <motion.label
      ...
      initial="hidden"
      animate="visible"
      className={`pointer-events-none absolute left-10 select-none whitespace-nowrap rounded-full px-1.5 text-white/70 transition-all duration-300 ease-[cubic-bezier(0.16,1,0.3,1)] ${
        isFloating
